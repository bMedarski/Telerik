namespace MineSweeper
{
    ...
    internal class GameEngine
    {
        ...
        public static void Run()
        {
            ...
            List<Points> hignScoreInfo = new List<Points>(MaxHighScoreLength);
            int row = 0;
            int col = 0;
            bool isNewGame = true;
            ...
            do
            {
                ...
                if (isMineExploded)
                {
                    ...
                    Points currentPlayer = new Points(nickname, pointsCounter);
                    ...
                    else
                    {
                        ...
                        {
                            if (hignScoreInfo[i].PlayerScore < currentPlayer.PlayerScore)
                            {
                    ...
                    hignScoreInfo.Sort((Points firstPlayerInfo, Points nextPlayerInfo) =>
                    nextPlayerInfo.PlayerName.CompareTo(firstPlayerInfo.PlayerName));
                    hignScoreInfo.Sort((Points firstPlayerInfo, Points nextPlayerInfo) =>
                    nextPlayerInfo.PlayerScore.CompareTo(firstPlayerInfo.PlayerScore));
                    ShowHighScoreList(hignScoreInfo);
                ...
                if (isGameOver)
                {
                    ...
                    Console.WriteLine(EnterYourNickName);
                    string nickname = Console.ReadLine();
                    Points currentPlayerInfo = new Points(nickname, pointsCounter);
        ...
        private static void ShowHighScoreList(List<Points> highScoreInfo)
        {
            ...
            if (highScoreInfo.Count > 0)
            {
                ...
                {
                    Console.WriteLine($"{i}. {highScoreInfo[i].PlayerName} --> {highScoreInfo[i].PlayerScore}");
                }
